...
export default function ViewInvoicePage({ invoice = SAMPLE_INVOICE, onGoBack, onDelete, onUpdate }) {
  ...
  return (
    <div className="max-w-[780px] mx-auto px-6 pt-14 pb-20 relative">
      {/* Go Back */}
      <button
        onClick={onGoBack}
      ...
      <div className="flex items-center justify-between bg-white dark:bg-dark-card rounded-xl px-8 py-5 mb-6 shadow-card dark:shadow-card-dark">
        <div className="flex items-center gap-5">
          <span className="font-spartan text-[13px] text-text-body">Status</span>
      ...
      <div className="bg-white dark:bg-dark-card rounded-xl p-12 shadow-card dark:shadow-card-dark">
        ...
        <div className="flex justify-between mb-10">
          <div>
            <h2 className="font-spartan font-bold text-[16px] text-text-dark dark:text-white mb-2">
              <span className="text-text-body">#</span>{currentInvoice.id}
            </h2>
            <p className="font-spartan text-[13px] text-text-body">{currentInvoice.description}</p>
          </div>
        ...
        <div className="grid grid-cols-3 gap-8 mb-12">
          ...
          <div className="space-y-8">
            <div>
              <p className="font-spartan text-[13px] text-text-body mb-2">Invoice Date</p>
              <p className="font-spartan font-bold text-[15px] text-text-dark dark:text-white">
                {currentInvoice.invoiceDate}
              </p>
            </div>
            <div>
              <p className="font-spartan text-[13px] text-text-body mb-2">Payment Due</p>
              <p className="font-spartan font-bold text-[15px] text-text-dark dark:text-white">
          ...
          {/* Bill To */}
          <div>
            <p className="font-spartan text-[13px] text-text-body mb-2">Bill To</p>
          ...
          {/* Sent To */}
          <div>
            <p className="font-spartan text-[13px] text-text-body mb-2">Sent to</p>
            <p className="font-spartan font-bold text-[15px] text-text-dark dark:text-white">
        ...
        <div className="bg-light-bg dark:bg-dark-card-2 rounded-xl overflow-hidden">
          ...
          <div className="grid grid-cols-[1fr_80px_120px_120px] gap-4 px-8 py-5">
            <span className="font-spartan text-[11px] text-text-body">Item Name</span>
            <span className="font-spartan text-[11px] text-text-body text-center">QTY.</span>
            <span className="font-spartan text-[11px] text-text-body text-right">Price</span>
            <span className="font-spartan text-[11px] text-text-body text-right">Total</span>
          </div>
          ...
          <div className="bg-amount-bg dark:bg-dark-bg rounded-b-xl flex items-center justify-between px-8 py-6 mt-2">
            <span className="font-spartan text-[13px] text-white">Amount Due</span>
